...
<OverviewLink href="/how-to/accessibility" title="无障碍图标" desc="应用程序中无障碍图标的最佳实践。"/>

只有当图标**本身传达基本含义**时，才应使其具有无障碍性。下面的部分解释了如何在 Astro 中做到这一点。
